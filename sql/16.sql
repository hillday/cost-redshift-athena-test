select /* TPC-DS query34.tpl 0.73 */ c_last_name
   ...
   (select ss_ticket_number
          ,ss_customer_sk
          ,count(*) cnt
    from "tpcds_orc_1000".store_sales,"tpcds_orc_1000".date_dim,"tpcds_orc_1000".store,"tpcds_orc_1000".household_demographics
    ...
    group by ss_ticket_number,ss_customer_sk) dn,"tpcds_orc_1000".customer
